...
namespace Net.Http.WebApi.OData.Model
{
    ...
    public sealed class EdmPrimitiveType : EdmType
    {
        ...
        /// </summary>
        public static EdmType Binary { get; } = new EdmPrimitiveType("Edm.Binary", typeof(byte[]));

        /// <summary>
        /// Gets the EdmType which represents the mathematical concept of binary-valued logic.
        /// </summary>
        public static EdmType Boolean { get; } = new EdmPrimitiveType("Edm.Boolean", typeof(bool));
        ...
        /// </summary>
        public static EdmType DateTimeOffset { get; } = new EdmPrimitiveType("Edm.DateTimeOffset", typeof(DateTimeOffset));
        ...
        /// </summary>
        public static EdmType Decimal { get; } = new EdmPrimitiveType("Edm.Decimal", typeof(decimal));
        ...
        /// </summary>
        public static EdmType Guid { get; } = new EdmPrimitiveType("Edm.Guid", typeof(Guid));

        /// <summary>
        /// Gets the EdmType which represents a signed 16-bit integer value.
        /// </summary>
        public static EdmType Int16 { get; } = new EdmPrimitiveType("Edm.Int16", typeof(short));

        /// <summary>
        /// Gets the EdmType which represents a signed 32-bit integer value.
        /// </summary>
        public static EdmType Int32 { get; } = new EdmPrimitiveType("Edm.Int32", typeof(int));

        /// <summary>
        /// Gets the EdmType which represents a signed 64-bit integer value.
        /// </summary>
        public static EdmType Int64 { get; } = new EdmPrimitiveType("Edm.Int64", typeof(long));

        /// <summary>
        /// Gets the EdmType which represents a signed 8-bit integer value.
        /// </summary>
        public static EdmType SByte { get; } = new EdmPrimitiveType("Edm.SByte", typeof(sbyte));
        ...
        /// </summary>
        public static EdmType Single { get; } = new EdmPrimitiveType("Edm.Single", typeof(float));
