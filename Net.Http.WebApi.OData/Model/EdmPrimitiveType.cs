...
namespace Net.Http.WebApi.OData.Model
{
    ...
    internal sealed class EdmPrimitiveType : EdmType
    {
        ...
        /// </summary>
        internal static EdmType Date { get; } = new EdmPrimitiveType("Edm.Date", typeof(DateTime));
        ...
        /// </summary>
        internal static EdmType Duration { get; } = new EdmPrimitiveType("Edm.Duration", typeof(TimeSpan));
        ...
        /// </summary>
        internal static EdmType TimeOfDay { get; } = new EdmPrimitiveType("Edm.TimeOfDay", typeof(TimeSpan));
    }
}