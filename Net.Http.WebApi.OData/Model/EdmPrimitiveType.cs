...
namespace Net.Http.WebApi.OData.Model
{
    ...
    public sealed class EdmPrimitiveType : EdmType
    {
        ...
        /// </summary>
        public static EdmType DateTime { get; } = new EdmPrimitiveType("DateTime", "Edm.DateTime", typeof(DateTime));
        ...
        /// </summary>
        public static EdmType Time { get; } = new EdmPrimitiveType("Time", "Edm.Time", typeof(TimeSpan));
    }
}