namespace Net.Http.WebApi.OData.Tests
{
    ...
    public class ODataResponseContentSerializationTests
    {
        ...
        public void JsonSerializationWith_Context_ClassContent_Count()
        {
            ...
            Assert.Equal("{\"odata.metadata\":\"http://services.odata.org/OData/$metadata#Products\",\"odata.count\":12,\"value\":[{\"Name\":\"Coffee\",\"Total\":2.55}]}", jsonResult);
        }
        ...
        public void JsonSerializationWith_Context_ClassContent_Count_NextLink()
        {
            ...
            Assert.Equal("{\"odata.metadata\":\"http://services.odata.org/OData/$metadata#Products\",\"odata.count\":12,\"odata.nextLink\":\"http://services.odata.org/OData/Products?$skip=5\",\"value\":[{\"Name\":\"Coffee\",\"Total\":2.55}]}", jsonResult);
        }
        ...
        public void JsonSerializationWith_Context_DynamicContent_Count()
        {
            ...
            Assert.Equal("{\"odata.metadata\":\"http://services.odata.org/OData/$metadata#Products\",\"odata.count\":12,\"value\":[{\"Id\":14225,\"Name\":\"Fred\"}]}", jsonResult);
        }
        ...
        public void JsonSerializationWith_Context_DynamicContent_Count_NextLink()
        {
            ...
            Assert.Equal("{\"odata.metadata\":\"http://services.odata.org/OData/$metadata#Products\",\"odata.count\":12,\"odata.nextLink\":\"http://services.odata.org/OData/Products?$skip=5\",\"value\":[{\"Id\":14225,\"Name\":\"Fred\"}]}", jsonResult);
        }
