namespace Net.Http.WebApi.OData.Tests.Query.Parsers
{
    ...
    public partial class FilterExpressionParserTests
    {
        public class SingleValueFunctionCallTests
        {
            ...
            {
                var queryNode = FilterExpressionParser.Parse("substringof('Alfreds', CompanyName) eq true", EntityDataModel.Current.EntitySets["Customers"]);
                ...
                Assert.IsType<PropertyAccessNode>(nodeLeft.Parameters[1]);
                Assert.Equal("CompanyName", ((PropertyAccessNode)nodeLeft.Parameters[1]).Property.Name);
            ...
            {
                var queryNode = FilterExpressionParser.Parse("substringof('Alfreds', CompanyName)", EntityDataModel.Current.EntitySets["Customers"]);
                ...
                Assert.Equal("CompanyName", ((PropertyAccessNode)node.Parameters[1]).Property.Name);
            }
