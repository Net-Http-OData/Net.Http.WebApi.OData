namespace Net.Http.WebApi.OData.Tests.Query.Parsers
{
    ...
    public partial class FilterExpressionParserTests
    {
        public class ComplexExpressionTests
        {
            ...
            {
                var queryNode = FilterExpressionParser.Parse("(Rating eq 5) and (ReleaseDate ge 2015-02-06T00:00:00 and ReleaseDate le 2015-02-06T23:59:59) and (Price eq 150.00M)", EntityDataModel.Current.EntitySets["Products"]);
            ...
            {
                var queryNode = FilterExpressionParser.Parse("(ReleaseDate ge 2015-02-06T00:00:00 and ReleaseDate le 2015-02-06T23:59:59 and Price eq 200.00M) and (Rating eq 3 or Rating eq 4 or Rating eq 5)", EntityDataModel.Current.EntitySets["Products"]);
            ...
            {
                var queryNode = FilterExpressionParser.Parse("(ReleaseDate ge 2015-02-06T00:00:00 and ReleaseDate le 2015-02-06T23:59:59) and (Rating eq 3 or Rating eq 4 or Rating eq 5)", EntityDataModel.Current.EntitySets["Products"]);
            ...
            {
                var queryNode = FilterExpressionParser.Parse("(ReleaseDate ge 2015-03-01T00:00:00 and ReleaseDate le 2015-03-31T23:59:59) and ((Deleted eq false and substringof('ilk', Description) eq true) or (Deleted eq false and substringof('rrots', Description) eq true))", EntityDataModel.Current.EntitySets["Products"]);
