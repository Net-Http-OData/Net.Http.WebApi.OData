...
{
    public class GetServiceDocumentTests_MetadataNone_FormatPrecedenceOverAccept : IntegrationTest
    {
        private readonly HttpResponseMessage _response;

        public GetServiceDocumentTests_MetadataNone_FormatPrecedenceOverAccept()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Get, "http://server/odata?$format=application/json;odata.metadata=none");
